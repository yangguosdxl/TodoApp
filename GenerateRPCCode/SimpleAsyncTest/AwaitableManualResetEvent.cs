...
//https://www.badflyer.com/asyncmanualresetevent

namespace SimpleAsyncTest
{
    class AwaitableManualResetEvent
    {
        ...
        public AwaitableManualResetEvent(bool isSet)
        ...
        public AwaitableManualResetEvent(bool isSet, bool runSynchronousContinuationsOnSetThread)
        {
        ...
        {
            return this.AwaitCompletion(AwaitableManualResetEvent.WaitIndefinitly, default(CancellationToken));
        }
        ...
        {
            return this.AwaitCompletion(AwaitableManualResetEvent.WaitIndefinitly, token);
        }
